...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    //修改上架时间
    $goods['q_add_time_format'] = local_date('Y-m-d',$goods['add_time']);
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $q_add_time_format = (empty($q_add_time_format) && isset($_POST['q_add_time_format'])) ? $_POST['q_add_time_format'] : false;
    if ($q_add_time_format)
    {
        $q_add_time = local_strtotime($q_add_time_format);
    }
    ...
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
                ...
                (isset($q_add_time) ? "add_time = '$q_add_time', " : "").
