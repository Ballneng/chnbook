...
/**
 * 获得所有地方省考教材
 * 现在先写死在程序里面，以后有时间再单独写一个类似的功能
 */
function get_province_goods()
{
    return array(
        46=>'国家',42=>'江苏',4=>'广东',5=>'江西',
        6=>'福建',10=>'湖北',45=>'事业单位',47=>'浙江',
        25=>'安徽',27=>'北京',26=>'上海',40=>'河南',
        16=>'重庆',17=>'海南',18=>'河北',39=>'山东',
        19=>'辽宁',14=>'广西',24=>'湖南',20=>'甘肃',
        23=>'陕西',22=>'云南',21=>'山西',33=>'青海',
        30=>'四川',31=>'吉林',32=>'新疆',34=>'贵州',
        35=>'西藏',36=>'宁夏',15=>'内蒙古',13=>'黑龙江',
        38=>'天津',
    );
}
?>